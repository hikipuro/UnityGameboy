...
void __stdcall initTgbDual()
{
	//log_file = freopen("debug.txt", "a", stdout);
    //fprintf(log_file, "initTgbDual\n");
	//fclose(log_file);

	render[0] = new unity_renderer();
	
	//log_file = freopen("debug.txt", "a", stdout);
    //fprintf(log_file, "render[0]: %02x\n", render[0]);
	//fclose(log_file);
	//printf("render[0]: %02x\n", render[0]);
	/*
	...
	*/
	...
	//log_file = freopen("debug.txt", "a", stdout);
    //fprintf(log_file, "initTgbDual end\n");
	//fclose(log_file);
}

void __stdcall freeTgbDual() {
	//log_file = freopen("debug.txt", "a", stdout);
    //fprintf(log_file, "freeTgbDual\n");
	//fclose(log_file);
...
void __stdcall loadRom(int size, unsigned char* dat)
{
    ...
    //inline_as3("%0 = num;" : "=r"(num));
    //inline_as3("%0 = bytes.length;" : "=r"(size));
    //dat = (unsigned char *)malloc(size);
	//inline_as3("CModule.writeBytes(%0, bytes.length, bytes);" :: "r"(dat));
